...
from util.file_explorer import MODELS_DIR, CONFIG_FILENAME, DATA_PRED_DIR, SEP, makedir
...
class ModelPredComb:
    ...
    def get_metrics(self) -> list:
        roc_auc, pr_auc, self.tpr = calculate_metrics(self.y_true, self.y_pred)
...
def evaluate(model_dir: str) -> None:
    ...
    for comb in PRED_COMBS:
        ...
        # Group predictions (based on models)
        for set in comb:
